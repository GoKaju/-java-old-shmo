...
//    String clie = "102";
    ...
    cons.setParameter(3, manejadorFechas.DevuelveFormato(manejadorFechas.retornaTimestamp(fini, "yyyy-MM-dd"), "yyyy-MM-dd"));
    cons.setParameter(4, manejadorFechas.DevuelveFormato(manejadorFechas.retornaTimestamp(ffin + " 23:59:59", "yyyy-MM-dd HH:mm:ss"), "yyyy-MM-dd HH:mm:ss"));

    System.out.println("list 1 --> " + manejadorFechas.DevuelveFormato(manejadorFechas.retornaTimestamp(fini, "yyyy-MM-dd"), "yyyy-MM-dd"));
    System.out.println("list 1 --> " + manejadorFechas.DevuelveFormato(manejadorFechas.retornaTimestamp(ffin + " 23:59:59", "yyyy-MM-dd HH:mm:ss"), "yyyy-MM-dd HH:mm:ss"));

    List<Object[]> lisExamenes = cons.getResultList();
    System.out.println("list 1 --> " + lisExamenes.size());
    ...
    cons2.setParameter(3, manejadorFechas.DevuelveFormato(manejadorFechas.retornaTimestamp(fini, "yyyy-MM-dd"), "yyyy-MM-dd"));
    cons2.setParameter(4, manejadorFechas.DevuelveFormato(manejadorFechas.retornaTimestamp(ffin + " 23:59:59", "yyyy-MM-dd HH:mm:ss"), "yyyy-MM-dd HH:mm:ss"));
    ...
    <body>
        ...
        %> 
                <tr>
                    ...
                    <td style="border: none"></td>
                    <td><%=cs.servicioNom%></td>
                    <td><%=cs.cont%></td>
<!--                    <td colspan="3">$ <%= o.getNumber(cs.cont)%></td>
                    <td colspan="3">$ <%= o.getNumber(cs.cont)%></td>-->
                </tr>
                <%}%>
            </tfoot>
