...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-lg-9">
                <h2 class="text-success">Factura - Modificar</h2>
            </div>
    ...
    <div class="panel-body">
        <div class="row">
            <div class="form-group col-md-3">
                ...
                <label class="control-label" for="tick_codigo"># Factura*</label>
                <input  id="fac_codigo" name="fac_codigo" placeholder="Consecutivo de la factura"  class="form-control " type="number" required  >
                <span class="help-block"></span>
            </div>
            <div class="col-md-3">
                <button onclick="peticionAjax('../Facturas','action=facturaModificar&fac_codigo='+$('#fac_codigo').val())" class="btn btn-circle btn-primary" type="button" style="margin-top:  25px" > <i class="glyphicon glyphicon-search"></i></button>
