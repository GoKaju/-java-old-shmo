...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-lg-9">
                <h2 class="text-success">Clientes Empresariales</h2>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 ...
                                 <button type="button"  onclick="RecargaPanel('../panels/formularios/basicas/clientes_sedefinca.jsp?clie_id=<%=clientesVO.getClieId()%>&idf=<%=idf%>','panelprincipal')"  class="btn btn-info ">Centros de costo</button>
                    <button type="button"  onclick="RecargaPanel('../panels/formularios/factura/centroCostos.jsp?clie_id=<%=clientesVO.getClieId()%>&idf=<%=idf%>','panelprincipal')"  class="btn btn-primary ">Sedes/Fincas</button>
               <%}%>
                                
                                <button type="button" value="<%=clientesVO.getClieId()%>" data-toggle="modal" data-target=".modal-ver" class="btn-circle btn-success bottom-right btn-outline" onclick="peticionAjax('../Clientes', 'action=CargarServicios&id=' + this.value), RecargaForm('../panels/formularios/basicas/Clientes.jsp?clie_ocu=' + this.value, 'cajaModalVer', 'modalContentVer')"><i class="glyphicon glyphicon-search"></i> </button>
                                <%if (rf.getRofu_op().indexOf("M") != -1) {%>
                           
                                <button type="button" value="<%=clientesVO.getClieId()%>" class="btn-circle btn-default bottom-right btn-outline" onclick="RecargaPanel('../panels/formularios/basicas/Clientes_nuevo.jsp?id_ocu=' + this.value+'&idf=<%=idf%>', 'panelprincipal')"><i class="glyphicon glyphicon-pencil"></i> </button><% }%>
                                <%if (rf.getRofu_op().indexOf("E") != -1) {%>   <button type="button" value="<%= clientesVO.getClieId()%>"  onclick="eliminarRegistro('../Clientes', 'action=eliminarCliente&id=' + this.value)" class="btn-circle btn-danger bottom-right btn-outline"><i class="glyphicon glyphicon-remove"></i> </button><% }%></td>
                    ...
                    <fieldset>
                        ...
                        <div class="row col-md-12">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input id="pege_documento" name="doc" placeholder="" pattern="^[0-9-]{1,}$" class="form-control" type="text" required   >
                                <span class="help-block"></span>
                            </div>
