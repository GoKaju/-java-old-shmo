...
<% 
    ...
    Pacientes paci = pacic.findPacientes(Integer.parseInt(request.getParameter("paci")));
%>
		...
		<div class="cd-timeline-block">
			...
			<div class="cd-timeline-img cd-picture">
                        ...
                        <%
                           ...
                           if(new ExamenesJpaController(emf2).findExamenes(a.getFormId().getExamId()).getExamTipo().equals("LABORATORIO")){ %>
			...
			<div class="cd-timeline-content">
                                ...
                                <h2 ><a style="color: #009900" href="#" 
                                        ...
                                        <%}else{%> onclick=" window.open('../Reportes?action=certificadoMedico&anot=<%=a.getAnotId()%>', 'certificadoMedico.pdf', 'toolbar=no,scrollbars=yes,resizable=yes,top=50,left=50,width=800,height=600')"
    ...
    <div class="row">
            ...
            <div class="col-lg-3 right">
                <div class="form-group">
                    ...
                    <button  onclick="RecargaPanel('../panels/formularios/hc/historiaBuscar.jsp', 'panelprincipal')" type="button" class="btn btn-default bottom-right btn-outline">Atras </button>
