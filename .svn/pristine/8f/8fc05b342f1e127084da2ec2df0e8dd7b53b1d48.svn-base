...
session.removeAttribute("listaItemCrearFactura");
...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        <div class="row">
            <div class="col-lg-9">
                <h2 class="text-success">Nueva Factura</h2>
            </div>
                ...
                <table id="tabla" class="table table-hover ">
                    ...
                    ClientesJpaController   ClientesDAO = new ClientesJpaController(emf);
                        ...
                        <tr>
                            ...
                            <td><button type="button" value="<%=clientesVO.getClieId()%>" title="Ver detalle" data-toggle="modal" data-target=".modal-ver" class="btn-circle btn-success bottom-right btn-outline" onclick="peticionAjax('../Clientes', 'action=CargarServicios&id=' + this.value),RecargaForm('../panels/formularios/basicas/Clientes.jsp?clie_ocu=' + this.value, 'cajaModalVer', 'modalContentVer')"><i class="glyphicon glyphicon-search"></i> </button>
                                <%if(rf.getRofu_op().indexOf("M")!= -1){%><button type="button" title="Seleccionar" value="<%=clientesVO.getClieId()%>" class="btn-circle btn-default bottom-right btn-outline" onclick="RecargaPanel('../panels/formularios/factura/FacturaNueva_p2.jsp?idf=<%=idf%>&clie_ocu='+ this.value, 'panelprincipal')"><i class="glyphicon glyphicon-pencil"></i> </button><% }%>
