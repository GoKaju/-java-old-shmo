...
import ocupacional.bdatos.historiaclinica.AntecedentesOcupacionalesEspecificosDAO;
 ...
 * @author Sebas
 */
@WebServlet(name = "Servlet_ctr_historiaclinica", urlPatterns = {"/HistoriaClinica"})
public class Servlet_ctr_historiaclinica extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (e != null) {
            ...
            System.out.println("hsitoriaclinica ctr: "+action);
            
            if (action.equals("ajaxAntecedentesOcupacionales")) {
                
                AntecedentesOcupacionalesEspecificosDAO aoedao= new AntecedentesOcupacionalesEspecificosDAO(e);
