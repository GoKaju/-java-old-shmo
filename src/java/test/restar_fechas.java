...
public class restar_fechas {
    ...
    public static String restar_fecha(String fi,String ff) {

//        String fechaInicio = "23/09/1992";
//        String fechaActual = "22/09/2016";
        String fechaInicio = fi;
        String fechaActual = ff;
        if(fechaActual==null ){
        Date date = new Date();
